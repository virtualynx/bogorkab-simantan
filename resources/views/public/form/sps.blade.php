            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">SARPAS SPS</h1>
                    </div>
                </div>
            </div>
    </section>
                ...
                <form id="form-tk" class="needs-validation" novalidate="" action="#" method="post" autocomplete="off">
                    ...
                    <div class="row gx-2">
                        <div class="col-lg-12 col-md-9 p-5">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-7">7. memiliki jumlah ruang <span class="text-lowercase">dan</span> luas lahan minimal 3 m<sup>2</sup> per anak</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-8">8. Memiliki Ruang untuk aktivitas anak didik di dalam <span class="text-lowercase">dan</span> di luar</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-9">9. memiliki Fasilitas Cuci Tangan Dengan Air Bersih</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-10">10. Memiliki Kamar mandi/jamban <span class="text-lowercase">yang</span> mudah dijangkau oleh anak dengan air bersih <span class="text-lowercase">yang</span> aman <span class="text-lowercase">dan</span> sehat</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-11">11. Memiliki Fasilitas permainan di dalam <span class="text-lowercase">dan</span> di luar ruangan <span class="text-lowercase">yang</span> aman <span class="text-lowercase">dan</span> sehat</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-12">12. memiliki tempat sambah <span class="text-lowercase">yang</span> tertutup <span class="text-lowercase">dan</span> tidak tercemar</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-13">13. Memiliki ruang tempat beribadah</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-14">14. Memiliki ruang laktasi (Ruang penampungan ASI untuk putra/putrinya di rumah)</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-15">15. memiliki ruang administrasi</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-16">16. memiliki ruang literasi</label>
                                <div class="col">
                                    <div class="form-check">
