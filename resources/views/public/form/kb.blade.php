                ...
                <form id="form-tk" class="needs-validation" novalidate="" action="#" method="post" autocomplete="off">
                    ...
                    <div class="row gx-2">
                        <div class="col-lg-12 col-md-9 p-5">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-7">7. memiliki jumlah ruang <span class="text-lowercase">dan</span> luas lahan sesuai dengan jumlah anak minimal 3 m<sup>2</sup> per anak/literasi</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-8">8. Memiliki ruang <span class="text-lowercase">dan</span> fasilitas aktivitas anak di dalam <span class="text-lowercase">dan</span> di luar</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-9">9. fasilitas cuci tangan <span class="text-lowercase">dan</span> kamar mandi/jamban</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-10">10. tempat sampah <span class="text-lowercase">yang</span> tertutup <span class="text-lowercase">dan</span> tidak tercemar</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-11">11. Memiliki Ruang tempat ibadah</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-12">12. Memiliki Ruang laktasi (Ruang penampungan ASI untuk putra/putrinya di rumah)</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-13">13. Memiliki ruang admininstasi</label>
                                <div class="col">
                                    <div class="form-check">
                            ...
                            <div class="col">
                                <label class="col-form-label text-capitalize" for="k-14">14. Memiliki ruang literasi</label>
                                <div class="col">
                                    <div class="form-check">
